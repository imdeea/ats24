<?
$title = 'Liquid Injection Molding Service - Advanced Technology Supply';
$meta_descr = 'ATS specialize in Liquid Injection Moulding for silicone and fluorosilicone elastomers. Our ISO Compliant LIM capabilities meet all military specifications';
$schema = "<script type='application/ld+json'>
{
  \"@context\": \"http://www.schema.org\",
  \"@type\": \"service\",
  \"brand\": \"Advanced Technology Supply, Inc\",
  \"url\": \"https://ats24.com/liquid-injection-molding.php\",
  \"name\": \"Liquid Injection Molding Services\",
  \"image\": \"https://ats24.com/images/liquid-injection-molding.png\",
  \"description\": \"ATS specialize in Liquid Injection Moulding for silicone and fluorosilicone elastomers. Our ISO Compliant LIM capabilities meet all military specifications\n\"
}
 </script>";
		...
		<div class="container">
			<div class="row">
				<div class="col-md-5 offset-md-1 col-md-push-7">
					<img class="blog-post-image" src="/images/liquid-injection-molding.png" alt="Liquid Injection Molding" title="Liquid Injection Molding" width="450" height="338">
				</div>
				<div class="col-md-6 col-md-pull-5">
					...
					<p class="mb30">
						...
						<br><br>
						Our ISO compliant liquid injection molding capabilities meet military specifications, as well as fulfill both food and medical grades. This service is not offered in-house and we only manage medium to high volume production jobs. <a href="contact.php">Contact</a> Advanced Technology Supply today to learn more about our liquid injection molding capabilities.
					</p>
		...
		<div class="container">
			<div class="row">
				...
				<article class="blog-post-content">
						<h2 class="mb20">Liquid Injection Molding Capabilities</h2>
				</article>
				</div>
			</div>
			<div class="row">
						 ...
						 <tbody>
							...
							<tr>
							   ...
							   <td class="noborder">
									ISO 9001:2008
									Mil Spec<br>
									Qualify for Veteran Owned Small Business
							  </td>
							   <td class="noborder">
							   </td>
							</tr>
							...
							<tr>
							   <td><strong>Product Capabilities</strong></td>
							   <td class="noborder">
									Micro Parts<br>
									Miniature<br>
									Small Parts
							...
							<tr>
							   <td><strong>Mold Process Type</strong></td>
							   <td class="noborder">
									Liquid Injection Molding (LIM)<br>

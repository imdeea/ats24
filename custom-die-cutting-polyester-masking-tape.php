<?
$title = 'Custom Die Cutting of Polyester Masking Tape | Electronics Industry';
$meta_descr = 'ATS 24 can manufacture various shapes and sizes of masking tape. Our special tape can be specifically designed for masking types of masking requirements';
		...
		<div class="container">
			<div class="row">
				...
				<article class="blog-post-content">
						<h2 class="mb20">Polyester Masking Tape Specifications</h2>
				</article>
				</div>
			</div>
			<div class="row">
					...
					<table>
						 <tbody>
							<tr>
							   ...
							   <td class="width65p">
									This custom die cut masking tape is used to mask of specific areas of circuit boards during the conformal coating process.
								</td>
							</tr>
							<tr>
							   ...
							   <td class="noborder">
									Die Cutting
									<ul>
									   <li>What type of shape is die cut? Rectangles and squares </li>
									</ul>
							  </td>
							</tr>
							<tr>
							   ...
							   <td class="noborder">
									Slit base material on single knife slitter then die cut on rotary die cutting machine
							  </td>
							</tr>
							<tr>
							   <td><strong>Masking Tape Type</strong></td>
							   <td class="noborder">
									ATS668 Masking Tape
									<ul>
									   <li>Designed Specifically for Conformal Coating Masking </li>
									   <li>Contains no Silicone Release Coat or Adhesive </li>
									</ul>
							  </td>
							</tr>
							<tr>
							   ...
							   <td class="noborder">
									Width, shape of tape? (1" squares to ¼" squares and rectangles
							  </td>
							</tr>
							<tr>

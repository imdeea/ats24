		...
		<div class="container">
			...
			<div class="row mb30">
				...
				<div class="col-md-7 col-sm-8">
					...
					For more information about our cost effective industrial solutions and accessories, or the other recognized products and capabilities please <a href="contact.php">contact</a> us directly.
				...
				<div class="col-md-5 col-sm-3">
					...
					<img class="blog-post-image" src="/images/industrial-applications.png" alt="Industrial Products" title="Industrial Products" width="450" height="338">

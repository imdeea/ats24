							...
							<div class="portfolio portfolio-boxed industry-app-gallery">
								<div class="col-sm-6 col-md-4 el above_ beyond_">
									<div class="portfolio-el view">
		                            	<img src="images/industry-appl/thumbs/window_frame_manufacturing_thumb.jpg" alt="Window Frame Manufacturing">
								...
								<div class="col-sm-6 col-md-4 el above_ beyond_">
									<div class="portfolio-el view">
		                            	<img src="images/industry-appl/thumbs/window_cutaway_thumb.jpg" alt="Window Cutaway (Tape releases melted plastic when welding corners of windows)">

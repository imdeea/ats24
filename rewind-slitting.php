<?
$title = 'Rewind Slitting Services | Perforating | Razor Slitting | ATS 24';
$meta_descr = 'Advanced Technology Supply, Inc. performs a variety of rewind slitting services, including perforating, razor slitting, and surface winding.';
$schema = "<script type='application/ld+json'>
{
  \"@context\": \"http://www.schema.org\",
  \"@type\": \"service\",
  \"brand\": \"Advanced Technology Supply, Inc\",
  \"url\": \"https://ats24.com/rewind-slitting.php\",
  \"name\": \"Rewind Slitting Services\",
  \"image\": \"https://ats24.com/images/rewind-slitting.png\",
  \"description\": \"Advanced Technology Supply, Inc. performs a variety of rewind slitting services, including perforating, razor slitting, and surface winding.\n\"
}
 </script>";
		...
		<div class="container">
			<div class="row">
				<div class="col-md-5 offset-md-1 col-md-push-7">
					<img class="blog-post-image" src="/images/rewind-slitting.png" alt="Rewind Slitting Services in Deerfield Beach, Florida, for Razor Slitting & Surface Rewinding" title="Rewind Slitting Services in Deerfield Beach, Florida, for Razor Slitting & Surface Rewinding" width="450" height="338">
				</div>
		...
		<div class="container">
			<div class="row">
				...
				<article class="blog-post-content">
						<h2 class="mb20">Rewind Slitting Capabilities</h2>
				</article>
				</div>
			</div>
			<div class="row">
				<div class="col-md-12">
					<table>
						 <tbody>
							<tr>
							   <td class="width30p"><strong>General Capabilities</strong></td>
							   <td class="width35p">
									Contract<br/>
									Large Format <br/>
									Offshore
							...
							<tr>
							   <td><strong>Slitting & Rewinding Methods</strong></td>
							   <td class="noborder">
									Perforating<br>
									Razor Slitting
							  </td>
							...
							<tr>
							   ...
							   <td class="noborder">
									Same Day (if inventory in stock)
							  </td>
							   <td class="noborder">
									up to 6 weeks
							   </td>
							...
							<tr>
							   <td><strong>How many blade wheels per machine</strong></td>
							   <td class="noborder">
									108
							  </td>
							   <td class="noborder">
							...
							<tr>
							   <td><strong>Material Width</strong></td>
							   <td class="noborder">
									Up to 27 in.
							  </td>
							   <td class="noborder">
							...
							<tr>
							   <td><strong>Roll Diameter</strong></td>
							   <td class="noborder">
									Up to 10 in.
							  </td>
							   <td class="noborder">
							...
							<tr>
							   <td><strong>Slit Web Width</strong></td>
							   <td class="noborder">
									3/8 to 27 in.
							  </td>
							   <td class="noborder">
							...
							<tr>
							   <td><strong>Material Thickness/Gauge</strong></td>
							   <td class="noborder">
									0.5 to 5 mil
							  </td>
							   <td class="noborder">
